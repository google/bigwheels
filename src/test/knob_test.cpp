...
TEST_F(KnobManagerTestFixture, KnobManager_GetBasicUsageMsg)
{
    ...
    std::shared_ptr<KnobConstant<bool>>        k5(km.CreateKnob<KnobConstant<bool>>("flag_name5", true));
    std::shared_ptr<KnobConstant<float>>       k6(km.CreateKnob<KnobConstant<float>>("flag_name6", 6.6f, 0.0f, 10.0f));
